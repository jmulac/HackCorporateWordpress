...
<section id="newsletter" class="newsletter <?php echo esc_attr($integral['newsletter-custom-class']); ?>">
    <?php if($integral['newsletter-overlay-toggle']==1) { ?><div class="blacklayer"></div><?php } ?>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <?php if ($integral['newsletter-title']) { ?><h2><?php echo $integral['newsletter-title']; ?></h2><?php } ?>
                    <?php if ($integral['newsletter-text']) { ?><p><?php echo $integral['newsletter-text']; ?></p><?php } ?>
                </div>
